<x-bootstrap title="Staffs">
    <div class="row g-4">
        <div class="col-lg-8">
            <a class="btn btn-success" href="{{ route('MRS.create') }}"> Create New Staff</a>
        </div>
        <div class="col-lg-4">
        ...
        @foreach ($MRSs as $item)
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">
                            <a href="{{ route('MRS.show', $item->id) }}">
                                {{ mb_substr($item->title, 0, 20) }} ...
                            </a>
                        </h5>
                        <p class="card-text">
                            {{ mb_substr($item->redate, 0, 130) }} ...
                        </p>
                        <p class="card-text fs-3">฿{{ number_format($item->addr) }}</p>
